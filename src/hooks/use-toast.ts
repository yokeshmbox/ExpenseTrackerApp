...
export const reducer = (state: State, action: Action): State => {
  switch (action.type) {
    ...
    case "REMOVE_TOAST": {
        ...
        // Find the toast and call its onAutoClose callback if it exists
        if (toastToRemove && toastToRemove.open === false) { // Ensure it was dismissed first
            toastToRemove.onAutoClose?.(toastToRemove);
        }
